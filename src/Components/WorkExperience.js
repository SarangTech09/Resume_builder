...
// Mapping the state to component props
const mapStateToProps = (state) => ({
  experiences: state.workExperienceReducer.experiences,
});

// Mapping the actions to component props
...
// Years for the Select component
const years = [
  "Present",
  "2024",
  "2023",
...
// Component for filling work experience details
const WorkExperience = (props) => {
  ...
  // Handle submitting the form and moving to the next step
  ...
  // Edit the job title of an experience
  ...
  // Edit the organization name of an experience
